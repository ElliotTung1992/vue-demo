package com.github.design_mode.iterator.part4;
...
class CafeMenu implements Menu{
    ...
    public CafeMenu(){
        addItem("Veggie Burger and air fries", "bbbbb", true, 3.99);
        addItem("salad", "aaaaa", false, 3.69);
        addItem("Burrito", "ccccc", true, 4.29);
